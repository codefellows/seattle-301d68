...
function displayPics() {
  ...
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the lettiable declaration from `var to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT
  // An error occurred because the variable "rando" became scoped to the "while" code block once the declaration was changed to "let".
  console.log(viewed);
