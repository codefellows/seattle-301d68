...
function displayPics(){
  ...
  // console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the declaration from `var to `const`.
  // I'm not entirely sure, except to say that const is locally scoped at the block level and is inside both a while loop as well as a function. The thing I don't understand is why, when it was var, it worked, since it was declared inside a function, meaing it only had local scope.
  console.log(viewed);
