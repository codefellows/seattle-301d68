...
function displayPics(){
  ...
  // It threw us an error because variables declared with const are scoped. The var that is rando, only has a single value declared within the scope of the loop it sits in. Therefore we would not be able to console.log the correct thing.
  console.log(viewed);
