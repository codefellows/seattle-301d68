...
// "this" is the Student object "joe"; the console log statement generates "undefined" because there is no return statement.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is the global window object
// 3. Explain why "this" is different when an arrow function is used.
// It is different because arrow functions are designed to inherit context from their enclosing function (which defaults to the global window if there is no enclosing function)
