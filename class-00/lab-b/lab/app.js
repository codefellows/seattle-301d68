...
// the object instance Student
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// The window
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions follow normal variable look up rules (while `this` uses lexixcal scope) so the arrow function find the window which is the largest object.
