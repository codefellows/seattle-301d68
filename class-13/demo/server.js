...
app.use(methodOverride('_method')); // we need this simply because a browser does not know how to make a put/delete req
...
function updateTask(req, res) {
  ...
  let SQL = `UPDATE tasks SET title=$1, description=$2, category=$3, contact=$4 WHERE id=$5`;
  let values = [title, description, category, contact, req.params.task_id];
