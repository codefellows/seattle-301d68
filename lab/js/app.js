...
function displayPics() {
  ...
  // Console says rando is not defined. It's a matter of scope. rando exists only inside of it's function. NOw that we converted global variables to let, we have locked rando in a box, so the console doesn't know how to define it.
  console.log(viewed);
